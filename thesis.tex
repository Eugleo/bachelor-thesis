...
\newacronym{db}{DB}{disulphide bond}
...
\newacronym{hcd}{HCD}{higher-energy C-trap dissociation}
\newacronym{lys}{LYS}{lysozyme}
\newacronym{lip}{LIP}{lipase}
\newacronym{genova}{GENOVA}{in-silico generated ovalbumin}
