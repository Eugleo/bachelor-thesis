...
\def\ThesisTypeTitle{\ifEN BACHELOR TH\gls*{esi}S \else BAKALÁŘSKÁ PRÁCE \fi}
%\def\ThesisTypeTitle{\ifEN MASTER TH\gls*{esi}S \else DIPLOMOVÁ PRÁCE \fi}
%\def\ThesisTypeTitle{\ifEN RIGOROUS TH\gls*{esi}S \else RIGORÓZNÍ PRÁCE \fi}
%\def\ThesisTypeTitle{\ifEN DOCTORAL TH\gls*{esi}S \else DISERTAČNÍ PRÁCE \fi}
